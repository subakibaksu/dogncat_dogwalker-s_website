		...
		<table>
			...
			<tr>
				...
				<td><input type="text" style="width: 90%;" maxlength="20"
					...
					<input type="button" value="ID확인" id="message" class="joinbtn"></td>
				<td id="idchecker"></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text" style="width: 100%;" maxlength="20"
					...
					<input type="button" value="닉네임 확인" id="messagenic" class="joinbtn"></td>
			...
			<tr>
				<td colspan="2">
				<input type="submit" id="checkit" class="joinbtn" value="가입완료" disabled="disabled"> &nbsp&nbsp 
				<input type="reset" class="joinbtn" value="입력취소">
				</td>
			</tr>
		</table>
	</form>
